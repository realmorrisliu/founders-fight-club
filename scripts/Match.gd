...
const TRAINING_DRILL_RECOVERY_START_OFFSET := Vector2(78.0, -104.0)
const TRAINING_DRILL_RECOVERY_START_VELOCITY := Vector2(-42.0, -12.0)
const TRAINING_DRILL_LEDGE_DUMMY_OFFSET_X := 108.0
const TRAINING_DRILL_DI_PLAYER_HP := 44
const TRAINING_DRILL_DI_LAUNCH_DELAY_SECONDS := 0.30
const TRAINING_DRILL_DI_DAMAGE := 18
const TRAINING_DRILL_DI_KNOCKBACK := Vector2(236.0, -296.0)
...
const ONBOARDING_STRIKE_RETREAT_BUFFER := 34.0
const ONBOARDING_THROW_CONTACT_BUFFER := 10.0
const ONBOARDING_SPECIAL_HP := 42
const ONBOARDING_DUMMY_ATTACK_DELAY_SECONDS := 0.18
const ONBOARDING_GUARD_TIMEOUT_SECONDS := 2.0
const ONBOARDING_THROW_TIMEOUT_SECONDS := 2.5
const ONBOARDING_DODGE_PUNISH_WINDOW_SECONDS := 0.70
const ONBOARDING_SPECIAL_PUNISH_WINDOW_SECONDS := 0.84
